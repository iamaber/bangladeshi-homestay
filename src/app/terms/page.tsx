      ...
      <main className="pt-16">
        ...
        <section className="pb-24 px-6 lg:px-14 bg-cream">
          <div className="max-w-[800px] mx-auto space-y-8">
            {[
              { title: "1. General", text: "These Terms and Conditions govern the use of the Bengali Homestay platform and the booking of homestay experiences in Bangladesh. By using our website and booking a stay, you agree to these terms in full." },
              ...
              { title: "6. Host Family Placement", text: "Guests may choose their preferred host family based on availability. Bengali Homestay reserves the right to reassign guests to another host family if the originally selected host becomes unavailable. In such cases, guests will be notified in advance and given the option to accept the alternative or receive a full refund." },
              { title: "7. Liability", text: "Bengali Homestay acts as an intermediary between guests and host families. While we carefully vet all host families, we are not liable for personal injury, loss of property, or other incidents that may occur during the stay. Guests are advised to obtain appropriate travel insurance." },
              ...
              { title: "9. Changes to Terms", text: "Bengali Homestay reserves the right to update these Terms and Conditions at any time. Changes will be posted on this page with an updated revision date." },
              { title: "10. Contact", text: "For questions about these terms, please contact us at hello@bengalihomestay.com." },
            ].map((section) => (
